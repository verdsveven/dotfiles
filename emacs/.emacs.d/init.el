...
(use-package cdlatex
  ...
  :config
  (add-to-list 'cdlatex-env-alist '("definition" "\\begin{definition}\nAUTOLABEL\n?\n\\end{definition}" nil))
  (add-to-list 'cdlatex-env-alist '("axiom" "\\begin{axiom}\nAUTOLABEL\n?\n\\end{axiom}" nil))
  (add-to-list 'cdlatex-env-alist '("theorem" "\\begin{theorem}\nAUTOLABEL\n?\n\\end{theorem}" nil))
  (add-to-list 'cdlatex-env-alist '("proposition" "\\begin{proposition}\nAUTOLABEL\n?\n\\end{proposition}" nil))
  (add-to-list 'cdlatex-env-alist '("lemma" "\\begin{lemma}\nAUTOLABEL\n?\n\\end{lemma}" nil))
  (add-to-list 'cdlatex-env-alist '("corollary" "\\begin{corollary}\nAUTOLABEL\n?\n\\end{corollary}" nil))
  (add-to-list 'cdlatex-env-alist '("proof" "\\begin{proof}\nAUTOLABEL\n?\n\\end{proof}" nil))
  (add-to-list 'cdlatex-env-alist '("remark" "\\begin{remark}\nAUTOLABEL\n?\n\\end{remark}" nil))
  (add-to-list 'cdlatex-env-alist '("example" "\\begin{example}\nAUTOLABEL\n?\n\\end{example}" nil))
  (add-to-list 'cdlatex-env-alist '("exercise" "\\begin{exercise}\nAUTOLABEL\n?\n\\end{exercise}" nil))
  (add-to-list 'cdlatex-env-alist '("split" "\\begin{split} ? \\end{split}" nil))
  (add-to-list 'cdlatex-command-alist '("def" "Insert a DEFINITION environment template" "" cdlatex-environment ("definition") t nil))
  (add-to-list 'cdlatex-command-alist '("axm" "Insert a AXIOM environment template" "" cdlatex-environment ("axiom") t nil))
  (add-to-list 'cdlatex-command-alist '("thm" "Insert a THEOREM environment template" "" cdlatex-environment ("theorem") t nil))
  (add-to-list 'cdlatex-command-alist '("prop" "Insert a PROPOSITION environment template" "" cdlatex-environment ("proposition") t nil))
  (add-to-list 'cdlatex-command-alist '("lma" "Insert a LEMMA environment template" "" cdlatex-environment ("lemma") t nil))
  (add-to-list 'cdlatex-command-alist '("cor" "Insert a COROLLARY environment template" "" cdlatex-environment ("corollary") t nil))
  (add-to-list 'cdlatex-command-alist '("prf" "Insert a PROOF environment template" "" cdlatex-environment ("proof") t nil))
  (add-to-list 'cdlatex-command-alist '("rem" "Insert a REMARK environment template" "" cdlatex-environment ("remark") t nil))
  (add-to-list 'cdlatex-command-alist '("ex" "Insert a EXAMPLE environment template" "" cdlatex-environment ("example") t nil))
  (add-to-list 'cdlatex-command-alist '("exer" "Insert a EXERCISE environment template" "" cdlatex-environment ("exercise") t nil))
  ...
  (add-to-list 'cdlatex-command-alist '("ev" "Evaluate" "\\left. ? \\right\\rvert" cdlatex-position-cursor nil nil t))
  (add-to-list 'cdlatex-command-alist '("pb" "Pullback" "{?}^{\\ast}" cdlatex-position-cursor nil nil t))
  (add-to-list 'cdlatex-command-alist '("pf" "Pushforward" "{?}_{\\ast}" cdlatex-position-cursor nil nil t))
  (add-to-list 'cdlatex-command-alist '("test" "Insert a test environment template" "" cdlatex-environment ("test") nil t))
  (add-to-list 'cdlatex-command-alist '("sp" "Insert a SPLIT environment template" "" cdlatex-environment ("split") nil t))
  (add-to-list 'cdlatex-command-alist '("func" "Insert a SPLIT environment template and define function" "\\begin{split} ? :  &\\to  \\\\  &\\mapsto  \\end{split}" cdlatex-position-cursor nil nil t))
  (add-to-list 'cdlatex-math-symbol-alist '(84 ("\\intercal" "\\dagger" "\\arctan")))
  (add-to-list 'cdlatex-math-symbol-alist '(42 ("\\times" "\\ast")))
  (add-to-list 'cdlatex-math-symbol-alist '(126 ("\\approx" "\\simeq" "\\cong")))
  (add-to-list 'cdlatex-math-symbol-alist '(61 ("\\Leftrightarrow" "\\Longleftrightarrow" "\\iff")))
  (add-to-list 'cdlatex-math-symbol-alist '(69 ("\\exists" "\\equiv" "\\ln")))
  (add-to-list 'cdlatex-math-symbol-alist '(46 ("\\cdot" "\\circ")))
  (add-to-list 'cdlatex-math-modify-alist '(115 "\\boldsymbol" nil t nil nil))
  (add-to-list 'cdlatex-math-modify-alist '(83 "\\slashed" nil t nil nil))
  )
